...
function SortBy({ sortBy, setSortBy, view, setView, compact = false, productCount }) {
  ...
  return (
    <div className="sortby">
      ...
      {/* <span>{productCount} {t('Product')}</span> */}
