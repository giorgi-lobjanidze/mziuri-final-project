  ...
  return (
    <div className='sortby'>
      <div className='view-icons'>
        <span className={view === 'grid-2' ? 'active' : ''} onClick={() => setView('grid-2')}>
        ...
        <span className={view === 'grid-3' ? 'active' : ''} onClick={() => setView('grid-3')}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className={view === 'grid-4' ? 'active' : ''} onClick={() => setView('grid-4')}>
