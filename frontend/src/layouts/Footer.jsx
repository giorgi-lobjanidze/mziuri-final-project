        ...
        <div className="footer-top">
          ...
          <div className={`footer-links ${openSection === 'company' ? 'open' : ''}`}>
            <h4 onClick={() => toggleSection('company')}>
              {t('OurCompany')}
              <svg className="footer-accordion-arrow" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M6 9l6 6 6-6" />
              </svg>
            </h4>
            <ul>
              ...
              <li><Link to="/stores">{t('OurStores')}</Link></li>
              <li><Link to="/contact">{t('ContactUs')}</Link></li>
              <li><Link to="/size-guide">{t('SizeGuide')}</Link></li>
              <li><Link to="/account">{t('MyAccount')}</Link></li>
            </ul>
          </div>
          ...
          <div className={`footer-links ${openSection === 'service' ? 'open' : ''}`}>
            ...
            <ul>
              ...
              <li><Link to="/faq">{t('ThemeFAQs')}</Link></li>
              <li><Link to="/refund">{t('RefundPolicy')}</Link></li>
              <li><Link to="/search">{t('AdvancedSearch')}</Link></li>
              <li><Link to="/locations">{t('StoreLocations')}</Link></li>
                ...
                <div className="newsletter-input-wrapper">
                  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                    <g clipPath="url(#clip0_13786_2931)">
                      <path d="M22.5571 3.5625H2.77588C1.61043 3.5625 0.666504 4.51228 0.666504 5.67188V18.3281C0.666504 19.4946 1.61736 20.4375 2.77588 20.4375H22.5571C23.7128 20.4375 24.6665 19.4986 24.6665 18.3281V5.67188C24.6665 4.51434 23.7263 3.5625 22.5571 3.5625ZM22.2617 4.96875C21.8308 5.39742 14.4141 12.775 14.1581 13.0297C13.7596 13.4281 13.2299 13.6475 12.6665 13.6475C12.1031 13.6475 11.5734 13.4281 11.1736 13.0284C11.0014 12.8571 3.66664 5.56097 3.07129 4.96875H22.2617ZM2.07275 18.0419V5.95898L8.14954 12.0037L2.07275 18.0419ZM3.07218 19.0312L9.14657 12.9955L10.1806 14.0241C10.8446 14.6881 11.7275 15.0538 12.6665 15.0538C13.6056 15.0538 14.4884 14.6881 15.1511 14.0254L16.1864 12.9955L22.2608 19.0312H3.07218ZM23.2603 18.0419L17.1835 12.0037L23.2603 5.95898V18.0419Z" fill="#1F1F1F" />
                    </g>
                    <defs>
