...
function SingleProduct() {
  ...
  const oldPrice = selectedVariant?.compare_at_price ? parseFloat(selectedVariant.compare_at_price) : null
      ...
      <div className='single-product'>
        ...
        <div className='single-info'>
          ...
          <div className='single-stock-bar'>
            <p>Hurry Up! Only <span className='stock-number'>{stockLeft}</span> Left In Stock!</p>
            <div className='stock-bar'>
              <div className='stock-fill' style={{ width: `${(stockLeft / stockTotal) * 100}%` }} />
            </div>
          </div>
          ...
          <div className='single-description'>
            <p>
              Red Grapes Tasty Beer brings together the best of fruity sweetness and smooth beer craftsmanship. This unique blend features the bold, rich flavors of red grapes perfectly balanced with a light maltiness, offering a refreshing and delightful taste. With its vibrant aroma and crisp texture, it’s an ideal choice for those who enjoy exploring unconventional flavors in their beverages. The subtle tanginess of the grapes adds a refreshing twist, making it a perfect companion for warm afternoons or casual get-togethers.
              <br /><br />
              Whether you’re unwinding after a long day or celebrating a special moment, Red Grapes Tasty Beer promises to elevate your experience. Best served chilled, it delivers a burst of fruity flavor that pairs wonderfully with light snacks or savory dishes. This beer is more than just a drink—it's an invitation to savor the unexpected, where the world of fruity wines meets the crisp satisfaction of beer.
            </p>
          </div>

          {/* free shipping */}
          <div className='single-freeship'>
            <p>Spend $500.00 More And Get <span>Free Shipping !</span></p>
          </div>

          {/* options */}
          {product.options.map(option => (
            <div key={option.name} className='single-option'>
              <label><strong>{option.name}:</strong> {selectedVariant?.[`option${option.position}`]}</label>
              <div className='single-option-values'>
                {option.values.map(val => (
                  <button
                    ...
                    onClick={() => {
                      const matched = product.variants.find(v => v[`option${option.position}`] === val)
          ...
          <div className='single-availability'>
            <p><span>Availability:</span> <em style={{ color: inStock ? 'green' : 'red' }}>{inStock ? 'In Stock' : 'Out of Stock'}</em></p>
            <p><span>Categories:</span> {product.tags.slice(0, 2).join(', ')}</p>
          ...
          <div className='single-buttons'>
            <button className='single-add-to-cart' disabled={!inStock}>
          ...
          <div className='single-delivery'>
            <p>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.0178 10.3086C17.7428 10.6002 18.1928 11.4586 18.0261 12.2169L17.6844 13.7669C17.0928 16.4336 15.0011 18.3336 11.9844 18.3336H8.01775C5.00108 18.3336 2.90942 16.4336 2.31775 13.7669L1.97608 12.2169C1.80942 11.4586 2.25941 10.6002 2.98441 10.3086L4.16776 9.83355L8.75943 7.99189C9.55943 7.67523 10.4427 7.67523 11.2427 7.99189L15.8344 9.83355L17.0178 10.3086Z" stroke="#515D66" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10 18.3335V8.3335" stroke="#515D66" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <p>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.1328 5.1416C15.7995 6.29993 16.9495 8.1416 17.1828 10.2666" stroke="#515D66" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M2.91016 10.3081C3.12682 8.19144 4.26016 6.34977 5.91016 5.18311" stroke="#515D66" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6.82422 17.4502C7.79089 17.9419 8.89089 18.2169 10.0492 18.2169C11.1659 18.2169 12.2159 17.9669 13.1576 17.5085" stroke="#515D66" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10.051 6.41654C11.3305 6.41654 12.3677 5.37933 12.3677 4.09987C12.3677 2.82041 11.3305 1.7832 10.051 1.7832C8.77158 1.7832 7.73438 2.82041 7.73438 4.09987C7.73438 5.37933 8.77158 6.41654 10.051 6.41654Z" stroke="#515D66" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className='single-share'>
            ...
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <defs>
                <clipPath id="clip0_22006_1187"><rect width="24" height="24" fill="white"/></clipPath>
              </defs>
            </svg></a>
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <defs>
                <clipPath id="clip0_22006_1189"><rect width="24" height="24" fill="white"/></clipPath>
              </defs>
            </svg></a>
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <defs>
                <clipPath id="clip0_22006_1191"><rect width="24" height="24"/></clipPath>
              </defs>
            </svg></a>
          </div>
        </div>
